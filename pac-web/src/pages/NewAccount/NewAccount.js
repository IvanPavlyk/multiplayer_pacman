...
const NewAccount = () => {
  ...
  const [accountInfo, setAccountInfo] = useState(location.state.detail);
  ...
  const newAccountHandler = (event) => {
    ...
    axios
      .post('http://localhost:3002/add-user', accountInfo) //TODO: push url to enviornment variable or helper function
      .then((res) => {
